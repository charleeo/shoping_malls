<section class="mission">
    <div class="row justify-content-center">
        <div class="col-md-6 col-sm-10">
            <h4 class="some-headers">Our Role Call</h4>
            <p class="mss-text">
            ...
            <p class="mission-t text-secondary">
                So if you got a business, bring it here let's sell it and resell it and keep selling it.
            </p>
        </div>
    </div>
</section>
